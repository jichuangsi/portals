<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\web\Education\portals\template/index_style/default/hy\content\lylogin.htm";i:1564971312;s:74:"D:\web\Education\portals\template/index_style/toutiao/index/wap_layout.htm";i:1550039820;s:69:"D:\web\Education\portals\template\index_style\default\index\share.htm";i:1542707408;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="/public/static/hy/assets/style/login.css">
    ...
    <div class="center">
       ...
       <form action="/index.php/index/login/index.html" method="post">
        ...
        <div class="ipt">
            <em style="background-image: url(/public/static/hy/assets/images/zhanghao.png);background-size: 0.27rem;"></em><input type="text"  name="username" placeholder="请输入您的账号">
        </div>
        <div class="ipt">
            <em style="background-image: url(/public/static/hy/assets/images/pwd.png);background-size: 0.27rem;background-repeat-y: no-repeat;"></em><input type="password" name="password" placeholder="请输入您的密码">
        </div>
        <input type="hidden" name="isModular" value="1" />
        <button type="submit" class="btn">登录</button>
        <div class="text clearfix">
            <span class="fl" onclick="window.location.href='/index.php/hy/content/lyregister'">注册账号</span>
