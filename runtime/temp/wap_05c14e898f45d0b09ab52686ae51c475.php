<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\web\Education\portals\template/index_style/default/hy\content\personal.htm";i:1564485031;s:74:"D:\web\Education\portals\template/index_style/toutiao/index/wap_layout.htm";i:1550039820;s:69:"D:\web\Education\portals\template\index_style\default\index\share.htm";i:1542707408;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="/public/static/hy/assets/style/personal.css">
    ...
    <div class="myhead">
    	<div class="myuserinfo">
    		<div class="userinfo_left">
    			<div style="width: 1rem;height: 1rem;background-color: #a0499e;border-radius: 50%;margin: auto;">
    				<img src="<?php echo $userdb['icon']; ?>" />
    			</div>
    		</div>
    		<div class="userinfo_right">
    			<div style="line-height: 0.6rem;"><?php echo $userdb['username']; ?></div>
    			<div>电话：123456789</div>
    		</div>
    	</div>
    </div>
    <div class="myinfo">
    	<div class="myinfo_div" style="display: flex;">
    		<div class="d1"><div class="d11">1231</div><div>粉丝</div></div>
    		<div class="d1"><div class="d11">1231</div><div>粉丝</div></div>
    		<div class="d1"><div class="d11">1231</div><div>粉丝</div></div>
    	</div>
    </div>
    
    <div style="width: 6.69rem;margin: 0 auto;position: relative;top: -0.8rem;"><img style="width: 100%;" src="/public/static/hy/assets/images/advertisement_2.png"/></div>
    <div class="mycontent">
    	
	    <div class="menu_list">
	    	<div class="menu_list_1">
	    		<div class="list1">
		    		<div class="list1_1" style="background: url(/public/static/hy/assets/images/personalbei1.png);background-size: 100% 100%;">
		    			<img style="width: 0.31rem;height: 0.34rem;margin: auto;" src="/public/static/hy/assets/images/list_icon_1.png" />
		    		</div>
		    		<div class="list1_2">收益</div>
		    	</div>
		    	<div class="list1">
		    		<div class="list1_1" style="background: url(/public/static/hy/assets/images/personalbei2.png);background-size: 100% 100%;">
		    			<img style="width: 0.31rem;height: 0.34rem;margin: auto;"  src="/public/static/hy/assets/images/list_icon_2.png" />
		    		</div>
		    		<div class="list1_2">订单</div>
		    	</div>
		    	<div class="list1">
		    		<div class="list1_1" style="background: url(/public/static/hy/assets/images/personalbei3.png);background-size: 100% 100%;">
		    			<img style="width: 0.38rem;height: 0.35rem;margin: auto;" src="/public/static/hy/assets/images/list_icon_3.png" />
		    		</div>
		    		<div class="list1_2">粉丝</div>
		    	</div>
		    	<div class="list1">
		    		<div class="list1_1" style="background: url(/public/static/hy/assets/images/personalbei4.png);background-size: 100% 100%;">
		    			<img style="width: 0.37rem;height: 0.34rem;margin: auto;" src="/public/static/hy/assets/images/list_icon_4.png" />
		    		</div>
		    		<div class="list1_2">邀请</div>
		    	</div>
	    	</div>
	    </div>
    ...
    <div class="foot">
        <div onclick="window.location.href='/index.php/hy'">
            <img src="/public/static/hy/assets/images/homenot.png" alt="">
            <span>首页</span>
        </div>
        ...
        <div>
            <img src="/public/static/hy/assets/images/mydeyes.png" alt="">
            <span class="check">我的</span>
        </div>
    </div>
<?php 
