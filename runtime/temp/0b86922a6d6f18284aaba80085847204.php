...
<div class="Articletitle"><?php echo $info['title']; ?></div>
		...
		<div class="ArticleContent"><?php echo $info['content']; ?></div>
  ...
  <?php endforeach; endif; else: echo "" ;endif; ?> SHOWPAGE--><?php endif; fun('label@run_showpage_label','d41d8cd98f00b204e9800998ecf8427e',$info,['page'=>$page,'dirname'=>__FILE__,'tpl'=>'','field'=>'picurl,title,content','val'=>'info','cache_time'=>'0']); ?>
		<!--引用评论碎片-->
...
<?php if(is_array($rs['picurls']) || $rs['picurls'] instanceof \think\Collection || $rs['picurls'] instanceof \think\Paginator): $i = 0; $__LIST__ = $rs['picurls'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pic): $mod = ($i % 2 );++$i;if(($i<5)): ?>
	<li><span><img src="<?php echo $pic; ?>" style="max-width: 100%; max-height: 100%;"></span></li>
