<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\web\Education\portals\template/index_style/default/index\login\index.htm";i:1555325357;s:74:"D:\web\Education\portals\template/index_style/toutiao/index/wap_layout.htm";i:1550039820;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<form class="mui-input-group" action="<?php echo urls('login/index'); ?>" method="post">
	...
	<p style="text-align: center;display: none;">登录即表示你同意 <a style="color: #406599;" href="<?php echo urls('login/agreement'); ?>">&nbsp;用户协议&nbsp;</a>和 <a style="color: #406599;" href="<?php echo urls('login/privacypolicy'); ?>" onclick="ShowPrivacy()">&nbsp;隐私条款&nbsp;</a></p>
	<dl>
