<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\web\x1\template/index_style/default/giftshop\index\index.htm";i:1548581398;s:59:"D:\web\x1\template/index_style/toutiao/index/wap_layout.htm";i:1550039820;s:67:"D:\web\x1\template\index_style\default\giftshop\content\wapsort.htm";i:1550631024;s:72:"D:\web\x1\template\index_style\default\giftshop\content\waplistshop2.htm";i:1548149160;s:68:"D:\web\x1\template\index_style\default\giftshop\content\showmore.htm";i:1547462930;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
myScroll = new IScroll('.qb_ui_wapSortBoxCont', { scrollX: true, scrollY: false, mouseWheel: true,preventDefault: false,preventDefaultException: { tagName: /^(INPUT|TEXTAREA|BUTTON|SELECT|LI)$/ } });
	...
	<div class="Show_Shop_List">
		<?php if(defined('LABEL_DEBUG')): ?><!--LISTPAGE <!--shop_index001		--><?php if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
	...
	<ul>
		...
		<li>
		  ...
		  <?php endforeach; endif; else: echo "" ;endif; ?> LISTPAGE--><?php endif; $__array__=fun('label@run_listpage_label','shop_index001',['mid'=>$mid,'fid'=>$fid,'page'=>$page,'dirname'=>__FILE__,'field'=>'','val'=>'','tpl'=>'','rows'=>'10','where'=>'','status'=>'','order'=>'list','by'=>'desc','cache_time'=>'0']);$pages=$__array__['pages'];$shop_index001=$__array__['cfg']; ?>
	</div>
	...
	<script>
		var listurl='<?php fun('label@label_listpage_ajax_url','shop_index001'); ?>';
		var thispage=1;
		var TheListObj=$('.Show_Shop_List');
		var ThisRows=<?php echo $shop_index001['rows']; ?>;	//每页显示几条 务必要注意,这里的变量名shop_list02必须要与上面的标签名一样,并且前面有$
