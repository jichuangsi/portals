<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\web\x1\template/index_style/toutiao/cms\index/wap_index.htm";i:1552446059;s:59:"D:\web\x1\template/index_style/toutiao/index/wap_layout.htm";i:1550039820;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<script>
	$(function(){
//		$('.body_Footcont').css("background-color","red");
//		$(".votes").remove();
		$.get("/index.php/vote/",function(res){
			...
			//判断投票的项目是否有图片
			/*for(var i=0;i<voteoption;i++){
				var imgs=$('.ListVotes .Lists').eq(i).find('a');
				if($('.ListVotes .Lists').eq(i).find('a').find("img").attr("src")==""){
					$('.ListVotes .Lists').eq(i).find('a').hide();
				}
			}*/
